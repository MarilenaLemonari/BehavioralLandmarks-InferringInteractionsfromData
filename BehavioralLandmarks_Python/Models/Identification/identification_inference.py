...
# python3 C:\PROJECTS\BehavioralLandmarks\BehavioralLandmarks_Python\Models\Identification\identification_inference.py
# IN-THE-WILD DATA
# go to cd C:\PROJECTS\BehavioralLandmarks\BehavioralLandmarks_Python\Models\Identification
...
# PERFECT DATA:
folder_path = 'PythonFiles\\NoLandmarks\\TestData'  
...
# REAL DATA
#Load Image:
folder_path = os.getcwd() #TODO: change to real data
...
for tif_file in tqdm(tif_files):
    ...
    if (tif_file == "identifierDemo.png"):
        my_dict, loaded_images = crop_resize_image_test(image,25,15,tif_file,loaded_images) 
    else:
        my_dict, loaded_images = crop_resize_image_test(image,25,5,tif_file,loaded_images) 
...
with open('identifierDemo.json', 'w') as json_file:
